...
import { HANDLE_CLOSE_ADD, HANDLE_OPEN_ADD } from "../actions";
...
const mapStateToProps = (store) => {
	return {
		...
		modalAdd: store.modalAdd,
	};
};

const mapDispatchToProps = (dispatch) => {
	return {
		handleCloseAdd: () => dispatch({ type: HANDLE_CLOSE_ADD }),
		handleOpenAdd: () => dispatch({ type: HANDLE_OPEN_ADD }),
	};
};
